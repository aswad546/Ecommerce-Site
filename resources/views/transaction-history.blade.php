                ...
                <div class="box-body">
                    <table width="100%" class="table table-hover" id="dataTables-example">
                        ...
                        @if(count($transactions) == 0)
                            <tr>
                                <td style="text-align:center; padding-left: 250px; padding-right: 250px">No Transactions</td>
                            </tr>
                        @endif
                        @foreach($transactions as $transaction)
                            <tr>
                                ...
                                <td>${{number_format((float)$transaction['transaction_amount'], 2, '.', '')}}</td>


                                <td class="text-end">
                                    <a href="{{route('show.transaction.items', $transaction['transaction_id'])}}"
                                       class="btn btn-outline-danger btn-rounded">View</a>
                                </td>
                            </tr>
                        @endforeach
                        <!-- <tr>
