                    ...
                    <table width="100%" class="table table-hover" id="dataTables-example">
                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>${{number_format((float)$order['transaction_amount'], 2, '.', '')}}</td>


                                <td class="text-end">
                                    <a href="{{route('show.orders.products', $order['order_id'])}}"
                                       class="btn btn-outline-primary-2">View Order</a>
                                    <a href="{{route('cancel.order', $order['order_id'])}}"
                                       class="btn btn-outline-danger btn-rounded">Cancel Order</a>
