...
<div class="page-wrapper">
                ...
                <div class="header-right">
                    ...
                    <ul class="top-menu top-link-menu">
                        <li>
                            <a href="#">Links</a>
                            <ul>
                                <li><a href="#signin-modal" data-toggle="modal"><i class="icon-user"></i></a></li>
                            </ul>
                        </li>
                    </ul><!-- End .top-menu -->
    ...
    <div class="container">
        <div class="heading heading-flex mb-3">
            ...
            <div class="heading-right">
                <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="trending-women-link" data-toggle="tab" href="#trending-women-tab" role="tab" aria-controls="trending-women-tab" aria-selected="true">Latest Trends</a>
                    </li>
                    <!-- <li class="nav-item">
        ...
        <div class="tab-content tab-content-carousel">
            <div class="tab-pane p-0 fade active show" id="trending-women-tab" role="tabpanel" aria-labelledby="trending-women-link">
                            ...
                            <div class="tab-content" id="tab-content-5">
                                <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                    ...
                                    <!-- <div class="form-group">
                                        <button type="submit" class="btn btn-outline-primary-2" onclick="myFunction()">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-outline-primary-2" onclick="myFunction1()">
                                            <span>Settings</span>
                                        </button>
                                        <!-- <a href="#" class="forgot-link">Settings</a> -->
                                    </div><!-- End .form-group -->

                                    <div class="form-group">
                                        <button type="submit" class="btn btn-outline-primary-2" onclick="myFunction2()">
                                            <span>Log Out</span>
                                        </button>
                                        <!-- <a href="#" class="forgot-link">Log Out</a> -->
                                    </div><!-- End .form-group -->
